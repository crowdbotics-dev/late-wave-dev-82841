"""
Django settings for late_wave_dev_82841 project.
...
ROOT_URLCONF = 'late_wave_dev_82841.urls'
...
WSGI_APPLICATION = 'late_wave_dev_82841.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_wave_dev_82841 API",
    "DESCRIPTION": "API documentation for late_wave_dev_82841 App",
    "VERSION": "v1",
}
